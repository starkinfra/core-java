...
public final class Rest {
    ...
    public static String getRaw(String sdkVersion, String host, String apiVersion, String path, User user, String language, int timeout, Map<String, Object> options) throws IOException, Exception {
        return Response.fetch(
            host,
            sdkVersion,
            user,
